    ...
    <div className="bg-[#1F2937] text-white min-h-screen">
      ...
      {/* Hero Section */}
        ...
        <div className="bg-[#687a94]">
          <p className="text-4xl leading-tight text-primary text-center pt-16 border border-green-500">Dedicated. Resilient. Determined.</p>
          
        {/* Family Members Section */}
        <div className="flex flex-row items-center justify-between px-16 py-10 my-20 border-b border-t border-[#ffffff]">
          {/* Amy Key */}
          <div className="flex flex-col w-full justify-center items-center p-8 border border-yellow-500">
            <Avatar alt="Amy Key" src="/mom3.jpg" className="scale-150" sx={{ width: 150, height: 150 }}/>
            <h2 className="text-3xl font-semibold pt-14">Amy Key</h2>
          </div>
          <div className="ml-16 px-44 border border-yellow-500">
        ...
        <div className="flex flex-row items-center justify-between px-16 py-10 my-20 border-b border-t border-[#ffffff]">
          {/* Ethan Key */}
          <div className="mr-16 px-44 border border-yellow-500">
            <p className="text-center">
          ...
          <div className="flex flex-col w-full justify-center items-center p-8 border border-yellow-500">
            <Link href="/ethankey">
                <Avatar alt="Ethan Key" src="/me.jpg" className="scale-150" sx={{ width: 150, height: 150,
                  transition: "all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",
                  "&:hover": {
                    transform: "scale(1.6)", // Slightly enlarge on hover
                    boxShadow: "0px 4px 10px rgba(255, 255, 255, 0.5)", // Glow effect
                  },
                 }}/>
            </Link>
        ...
        <div className="flex flex-row items-center justify-between px-16 py-10 mt-20 border-b border-t border-[#ffffff]">
          {/* Bryce Key */}
          <div className="flex flex-col w-full justify-center items-center p-8 border border-yellow-500">
            <Avatar alt="Bryce Key" src="/bryce2.jpg" className="scale-150" sx={{ width: 150, height: 150 }}/>
